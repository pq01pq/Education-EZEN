...
public class DelayCountDriverCounter extends Configured implements Tool {
	
	public static void main(String[] args) throws Exception {
		ToolRunner.run(new Configuration(), new DelayCountDriverCounter(), args);
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(DelayCountDriverCounter.class);
		job.setMapperClass(DelayMapperCounter.class);
